...
num_eps = 200
# test_epocs = [5, 10, 20, 50, 100, 200]
test_epocs = [50, 100, 200]
...
# was 93^3
#ic, ea, _ = fs.voronoi2image(size=[512,512,512], ngrain=2**13)
...
modelname = './data/model_dim(3)_sz(9_9)_lr(5e-05)_reg(1)_ep(200)_kt(0.66)_freq(0.5)_cut(0).h5'
...
#modelname = fsp.train_primme(trainset, num_eps=200, obs_dim=9, act_dim=9, lr=5e-5, reg=1, if_miso=False, plot_freq=1, multi_epoch_safe=False, multi_epoch_list=test_epocs)
...
# cur_model = "./data/model_dim(3)_sz(9_9)_lr(5e-05)_reg(1)_ep(200)_kt(0.66)_freq(0.5)_cut(0)_at_epoch(5).h5"
# fp = "./data/primme_sz(512x512x512)_ng(1024)_nstepßs(400)_freq(1)_kt(0.66)_freq(0.5)_cut(0).h5"
#Last one
#fp = fsp.run_primme(ic, ea, nsteps=200, modelname=modelname, miso_array=ma, pad_mode='circular', if_miso=False, plot_freq=1)
fp = "./data/primme_sz(512x512x512)_ng(8192)_nsteps(200)_freq(1)_kt(0.66)_freq(0.5)_cut(0).h5"
fs.compute_grain_stats(fp)
fs.make_videos(fp, multi_res=True, epoch=200)
fs.make_3D_videos(fp,multi_res=True, epoch=200)
fs.make_time_plots(fp, multi_res=True, epoch=200)
